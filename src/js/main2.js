...
$('#bb1_1').hover(function(){
	...
	$(this).css('background','url("img/1-sizes.gif") 0 74px');				  
						  }
});
$('#bb2_1').hover(function(){
	$(this).css('background','url("img/1-sizes.gif") -80px 0');				  
						  },function(){	if (ChSize2_1==0) {
	$(this).css('background','url("img/1-sizes.gif") -80px 74px');				  
						  }
});
$('#bb3_1').hover(function(){
	$(this).css('background','url("img/1-sizes.gif") -160px 0');				  
						  },function(){	if (ChSize3_1==0) {					  
	$(this).css('background','url("img/1-sizes.gif") -160px 74px');				  
						  }
});
$('#bb4_1').hover(function(){
	$(this).css('background','url("img/1-sizes.gif") -240px 0');				  
						  },function(){	if (ChSize4_1==0) {					  
	$(this).css('background','url("img/1-sizes.gif") -240px 74px');				  
						  }
});
$('#bb5_1').hover(function(){
	$(this).css('background','url("img/1-sizes.gif") -320px 0');				  
						  },function(){	if (ChSize5_1==0) {					  
	$(this).css('background','url("img/1-sizes.gif") -320px 74px');				  
						  }
});
...
$('#bb1_1').click(function(){
	...
	ChSize4_1=0;
	ChSize5_1=0;
	$('#bb2_1').css('background','url("img/1-sizes.gif") -80px 74px');				  
	$('#bb3_1').css('background','url("img/1-sizes.gif") -160px 74px');
	$('#bb4_1').css('background','url("img/1-sizes.gif") -240px 74px');
	$('#bb5_1').css('background','url("img/1-sizes.gif") -320px 74px');
});
$('#bb2_1').click(function(){
	...
	ChSize4_1=0;
	ChSize5_1=0;
	$('#bb1_1').css('background','url("img/1-sizes.gif") 0 74px');
	$('#bb3_1').css('background','url("img/1-sizes.gif") -160px 74px');
	$('#bb4_1').css('background','url("img/1-sizes.gif") -240px 74px');
	$('#bb5_1').css('background','url("img/1-sizes.gif") -320px 74px');
...
$('#bb1_2').hover(function(){
	...
	$(this).css('background','url("img/2-sizes.gif") 0 74px');				  
						  }
});
$('#bb2_2').hover(function(){
	$(this).css('background','url("img/2-sizes.gif") -80px 0');				  
						  },function(){	if (ChSize2_2==0) {
	$(this).css('background','url("img/2-sizes.gif") -80px 74px');				  
						  }
});
$('#bb3_2').hover(function(){
	$(this).css('background','url("img/2-sizes.gif") -160px 0');				  
						  },function(){	if (ChSize3_2==0) {					  
	$(this).css('background','url("img/2-sizes.gif") -160px 74px');				  
						  }
});
$('#bb4_2').hover(function(){
	$(this).css('background','url("img/2-sizes.gif") -240px 0');				  
						  },function(){	if (ChSize4_2==0) {					  
	$(this).css('background','url("img/2-sizes.gif") -240px 74px');				  
						  }
});
$('#bb5_2').hover(function(){
	$(this).css('background','url("img/2-sizes.gif") -320px 0');				  
						  },function(){	if (ChSize5_2==0) {					  
	$(this).css('background','url("img/2-sizes.gif") -320px 74px');
						  }
});
...
$('#bb1_2').click(function(){
	...
	ChSize4_2=0;
	ChSize5_2=0;
	$('#bb2_2').css('background','url("img/2-sizes.gif") -80px 74px');				  
	$('#bb3_2').css('background','url("img/2-sizes.gif") -160px 74px');
	$('#bb4_2').css('background','url("img/2-sizes.gif") -240px 74px');
	$('#bb5_2').css('background','url("img/2-sizes.gif") -320px 74px');
});
$('#bb2_2').click(function(){
	...
	ChSize4_2=0;
	ChSize5_2=0;
	$('#bb1_2').css('background','url("img/2-sizes.gif") 0 74px');
	$('#bb3_2').css('background','url("img/2-sizes.gif") -160px 74px');
	$('#bb4_2').css('background','url("img/2-sizes.gif") -240px 74px');
	$('#bb5_2').css('background','url("img/2-sizes.gif") -320px 74px');
...
$('#bb3_2').click(function(){
	...
	ChSize4_2=0;
	ChSize5_2=0;
	$('#bb2_2').css('background','url("img/2-sizes.gif") -80px 74x');				  
	$('#bb1_2').css('background','url("img/2-sizes.gif") 0 74px');
	$('#bb4_2').css('background','url("img/2-sizes.gif") -240px 74px');
	$('#bb5_2').css('background','url("img/2-sizes.gif") -320px 74px');
});
...
$('#bb1_3').hover(function(){
	...
	$(this).css('background','url("img/3-sizes.gif") 0 74px');				  
						  }
});
$('#bb2_3').hover(function(){
	$(this).css('background','url("img/3-sizes.gif") -80px 0');				  
						  },function(){	if (ChSize2_3==0) {
	$(this).css('background','url("img/3-sizes.gif") -80px 74px');				  
						  }
});
$('#bb3_3').hover(function(){
	$(this).css('background','url("img/3-sizes.gif") -160px 0');				  
						  },function(){	if (ChSize3_3==0) {					  
	$(this).css('background','url("img/3-sizes.gif") -160px 74px');				  
						  }
});
$('#bb1_3').click(function(){
	...
	ChSize2_3=0;
	ChSize3_3=0;
	$('#bb2_3').css('background','url("img/3-sizes.gif") -80px 74px');
	$('#bb3_3').css('background','url("img/3-sizes.gif") -160px 74px');
});
$('#bb2_3').click(function(){
	...
	ChSize2_3=1;
	ChSize3_3=0;
	$('#bb1_3').css('background','url("img/3-sizes.gif") 0 74px');				  
	$('#bb3_3').css('background','url("img/3-sizes.gif") -160px 74px');					  
});
